...
http://example.com/france2.m3u8"""
    ...
    def test_filter_best_quality(self):
        ...
        entries = [
            {'name': 'TF1', 'working': True, 'height': 720, 'width': 1280, 'quality': '720p'},
            {'name': 'TF1', 'working': True, 'height': 1080, 'width': 1920, 'quality': '1080p'},
            {'name': 'France 2', 'working': True, 'height': 480, 'width': 854, 'quality': '480p'},
            {'name': 'France 2', 'working': False, 'height': 0, 'width': 0, 'quality': 'failed'},
        ]
    ...
    def test_write_playlist(self):
        ...
        entries = [
            {'name': 'TF1', 'info': '#EXTINF:-1 tvg-name="TF1",TF1', 'url': 'http://example.com/tf1.m3u8'},
            {'name': 'France 2', 'info': '#EXTINF:-1 tvg-name="France 2",France 2', 'url': 'http://example.com/france2.m3u8'},
        ]
